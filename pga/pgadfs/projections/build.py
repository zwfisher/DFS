    ...
    df = pd.DataFrame(
        {
            ...
            "fit": [g.fit_detail.fit if g.fit_detail else 0.0 for g in slate.golfers],
            "history": [g.fit_detail.history if g.fit_detail else 0.0 for g in slate.golfers],
            "tee": [g.tee_time for g in slate.golfers],
            "tee_slot": [g.tee_slot for g in slate.golfers],
